...
/**
 * Created by zhengqinglin on 2018/6/28.
 */
public class SVNUtils {
    /**
     * 日志记录
     */
    protected final static Logger LOG = LoggerFactory.getLogger(SVNUtils.class);
    ...
    public static boolean isWorkingCopy(File path){
        if(!path.exists()){
            LOG.warn("{} not exist!",path.getAbsolutePath());
            return false;
        }
        try {
...
//        } catch (SVNException e) {
//            e.printStackTrace();
//            LOG.error("验证svn地址{}是否存在，出现异常",url,e);
//        }
//        return false;
    }
    ...
    public static void main(String[] args) throws SVNException {
        String url = "http://svn.ruijie.net/svn/RCD/Version/文档归档/项目文档/2018云课堂项目归档/RCC_V3.5.X/RCC_V3.5_R1/开发阶段/内部测试/第三轮测试/测试用例";
        String userName = "gaoyanli";
        String password = "a397c9010";
        System.out.println(isURLExist(SVNURL.parseURIEncoded(url),userName,password));
    }
